...
type ShippingItem struct {
	...
	ProductCode   int64                  `protobuf:"varint,1,opt,name=product_code,json=productCode,proto3" json:"product_code,omitempty"`
...
func (x *ShippingItem) GetProductCode() int64 {
	if x != nil {
...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	"\fShippingItem\x12!\n" +
	"\fproduct_code\x18\x01 \x01(\x03R\vproductCode\x12\x1a\n" +
	"\bquantity\x18\x02 \x01(\x05R\bquantity\"Z\n" +
	"\x0fShippingRequest\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\x12,\n" +
	"\x05items\x18\x02 \x03(\v2\x16.shipping.ShippingItemR\x05items\"7\n" +
	"\x10ShippingResponse\x12#\n" +
	"\rdelivery_days\x18\x01 \x01(\x05R\fdeliveryDays2_\n" +
	"\x0fShippingService\x12L\n" +
	"\x13GetDeliveryEstimate\x12\x19.shipping.ShippingRequest\x1a\x1a.shipping.ShippingResponseBFZDgithub.com/cassiaagomes/microservices-proto/golang/shipping;shippingb\x06proto3"
...
var file_shipping_shipping_proto_depIdxs = []int32{
	...
	1, // 1: shipping.ShippingService.GetDeliveryEstimate:input_type -> shipping.ShippingRequest
	2, // 2: shipping.ShippingService.GetDeliveryEstimate:output_type -> shipping.ShippingResponse
