...
const (
	ShippingService_GetDeliveryEstimate_FullMethodName = "/shipping.ShippingService/GetDeliveryEstimate"
)
...
func (c *shippingServiceClient) GetDeliveryEstimate(ctx context.Context, in *ShippingRequest, opts ...grpc.CallOption) (*ShippingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShippingResponse)
	err := c.cc.Invoke(ctx, ShippingService_GetDeliveryEstimate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedShippingServiceServer) GetDeliveryEstimate(context.Context, *ShippingRequest) (*ShippingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDeliveryEstimate not implemented")
}
...
func _ShippingService_GetDeliveryEstimate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShippingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServiceServer).GetDeliveryEstimate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShippingService_GetDeliveryEstimate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServiceServer).GetDeliveryEstimate(ctx, req.(*ShippingRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ShippingService_GetDeliveryEstimate_Handler,
		},
	},
